    ...
    <div className="space-y-8 animate-fade-in text-left pb-10">
      ...
      <div className="bg-white border border-border-light rounded-md shadow-sm overflow-hidden flex flex-col min-h-[500px]">
        <div className="p-6 border-b border-border-light flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <h2 className="text-2xl font-black text-text-main tracking-tighter uppercase">Sales Ledger</h2>
          <div className="flex w-full md:w-auto gap-3">
             <div className="relative flex-1 md:w-64">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-neutral/30 border border-border-light rounded-md text-xs font-bold focus:bg-white focus:border-primary outline-none transition-all" 
                />
             </div>
             <Button 
               ...
               className={`!py-2 shadow-none ${showFilters ? '!bg-primary' : ''}`}
             >
               {showFilters ? 'Hide Filters' : 'Filters'}
             </Button>
             <Button onClick={() => setShowModal(true)} icon={Plus} className="!bg-primary hover:!bg-accent">Start Sale</Button>
          </div>
        </div>

        {showFilters && (
          <div className="px-6 py-4 bg-neutral/50 border-b border-border-light animate-in slide-in-from-top-2 duration-200">
