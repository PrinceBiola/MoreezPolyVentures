  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12 font-sans text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-3xl font-black text-text-main tracking-tighter uppercase">Dashboard</h2>
          <p className="text-text-muted font-bold text-[11px] tracking-tight mt-1.5 uppercase">Operational performance for selected period.</p>
        </div>
        <div className="flex items-center gap-4 bg-white border border-border-light px-4 py-2 rounded-md shadow-sm">
          <div className="flex items-center gap-3">
             <div className="flex flex-col">
                <label className="text-[8px] font-black text-text-muted uppercase tracking-widest mb-1">Start Date</label>
                <input 
                  type="date" 
                  value={startDate}
                  onChange={(e) => setStartDate(e.target.value)}
                  className="bg-transparent text-[11px] font-black text-text-main uppercase tracking-tight focus:outline-none cursor-pointer border-none p-0"
                />
             </div>
             <div className="w-px h-8 bg-neutral mx-2" />
             <div className="flex flex-col">
                <label className="text-[8px] font-black text-text-muted uppercase tracking-widest mb-1">End Date</label>
                <input 
                  type="date" 
                  value={endDate}
          ...
          <div className="bg-neutral p-1.5 rounded-md">
      ...
      <div className="bg-white border border-border-light rounded-md p-8 shadow-sm">
        <div className="flex justify-between items-center mb-10">
          <div>
            ...
            <p className="text-[10px] text-text-muted font-bold uppercase tracking-widest mt-1">Revenue & Expenses Overview</p>
          </div>
